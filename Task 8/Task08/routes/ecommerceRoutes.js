...
const products = [
  { id: 1, name: 'Product 1', price: 278 },
  { id: 2, name: 'Product 2', price: 397 },
  { id: 3, name: 'Product 3', price: 445 }
];
...
router.get('/products/:id', (req, res) => {
  ...
  if (!product) {
    res.status(404).send('Product did not not found');
    return;
  }
